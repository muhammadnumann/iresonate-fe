...
import { ContentProviderDetails } from 'src/form/registration-form/contentProviderForm'
//constant
...
import { ContentProviderRegisterSchema } from 'src/utils/formikValidation'
import { ContentWriterTermsCondition, stepFormDetails } from 'src/utils/enums'
import metaTitle from 'src/utils/metaTitle'
import { WSButton, WSTitle, } from 'src/component/common'
import WebsiteDetails from 'src/form/registration-form/contentProviderForm/websiteDetails'
...
> = ({
  ...
  errors,
    ...
    const handleFormSubmit = () => {
      ...
      values.userRole = UserRoles.CONTENT_WRITER;
      values.platformCharges = "50";
      ...
      <div className='donor-registration gap-5'>
        ...
        <div style={{ marginTop: "98px" }}>
          <div className='pt-5 text-center'>
            <WSTitle level={1}>Content Provider Registration</WSTitle>
          </div>
        </div>
        ...
        <div className="registration-steps">
          <section >
            <div className="container">
              <div className="my-4">
                <ContentProviderDetails setFieldValue={setHandleTitle} value={handleTitle}
                  city={city}
                  country={country}
                ...
                <PrimaryTheme cpForm={true} setHosting={setHosting} hosting={hosting} setPrimaryFocus={setPrimaryFocus} primaryFocus={primaryFocus} />
...
>({
  ...
  validationSchema: ContentProviderRegisterSchema,
