...
// Style
import "./contentProviderDetails.less"
import { titleCorporate } from 'src/utils/staticData'



const ContentProviderDetails = (
  { value, setFieldValue, city, setCity, state, setState, country, setCountry, postalCode, setPostalCode, address, setAddress }: any
) => {
  ...
  return (
    <>
      ...
      <div className='content-provider-main-details'>
        <WSTitle level={2} className='details-title'>
          {stepFormDetails.step1ContentProviderCorporateDetails}
        </WSTitle>
        <p className='content'>
          {stepFormDetails.ContentProiderContent}
        </p>
        <div className='content-provider-main-form mb-4'>
          <WSRow>
