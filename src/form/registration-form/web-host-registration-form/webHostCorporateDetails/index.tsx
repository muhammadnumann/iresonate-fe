...
// Style
import './webHostCorporateDetails.less'
import { titleCorporate } from 'src/utils/staticData'
import Autocomplete from "react-google-autocomplete";


const WebHostCorporateDetails = ({ value, setFieldValue, city, setCity, state, setState, country, setCountry, postalCode, setPostalCode, address, setAddress
}) => {
    ...
    <>
      ...
      <div className='web-host-corporate-main-details'>
        <WSTitle level={2} className='details-title'>
          {stepFormDetails.step1WebHostCorporateDetails}
        </WSTitle>
        <p className='content'>
...
export default WebHostCorporateDetails
